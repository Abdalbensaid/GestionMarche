       ...
       <li class="nav-item pcoded-hasmenu">
            <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-clipboard"></i></span><span class="pcoded-mtext">Gestion du Marché</span></a>
            <ul class="pcoded-submenu">
                <li><a href="{{route('contrat.index')}}" target="_blank">Gestion des contrats</a></li>
                <li><a href="{{route('secteur.index')}}" target="_blank">Gestion des secteurs d'activités</a></li>
            </ul>
        </li>
        <li class="nav-item">
